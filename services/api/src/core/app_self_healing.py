# Module: src/core/app_self_healing.py
# Defines function(s): create_application
#
#
...
def create_application() -> FastAPI:
    app = FastAPI(title='AI Code Reviewer with Self-Healing', description='Production-grade code review system with auto-fix capabilities', version='1.0.0', docs_url='/docs' if not settings.is_production else None, redoc_url='/redoc' if not settings.is_production else None)
