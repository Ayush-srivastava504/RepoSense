...
class AIService:
    ...
    async def auto_fix(self, code: str, language: str):
        ...
        return {'fixed_code': fix_result.fixed_code, 'applied_fixes': fix_result.applied_fixes, 'validation_passed': fix_result.validation_passed}
