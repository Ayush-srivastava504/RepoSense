        ...
        for _ in range(max_pages):
            ...
            for entry in entries:
                ...
                job = build_job(
                    ...
                    company=entry.get("company", {}).get("name", company) if isinstance(entry.get("company"), dict) else company,
                    location=location,
                    apply_url=apply_url,
                    is_remote=is_remote or None,
                    posted_date=str(entry.get("releasedDate", "") or ""),
