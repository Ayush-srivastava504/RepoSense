# Module: crawler/src/processors/hackathon_quality.py
# Defines function(s): score_batch, filter_low_quality, _score_one, _is_suspicious_domain
#
#
...
def filter_low_quality(hackathons: List[Dict], min_score: int=MIN_QUALITY_SCORE) -> List[Dict]:
    ...
    log.info('Quality filter: kept %d/%d hackathons (min_score=%d)', len(kept), len(hackathons), min_score)
    return kept
