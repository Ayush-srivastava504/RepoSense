...
def is_publicly_visible(status: str) -> bool:
    """Only upcoming/ongoing hackathons are shown by default — ended and
    registration_closed listings are kept in the DB (for a future archive
    page) but excluded from /api/hackathons results."""
