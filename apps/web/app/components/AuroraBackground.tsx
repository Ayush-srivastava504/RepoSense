// Module: app/components/AuroraBackground.tsx
// Defines component(s)/export(s): COLOR_VAR, AuroraBackground
// Defines function(s): makeParticles
// Defines type(s): Particle
...
export default function AuroraBackground({ particleCount = 14 }: {
