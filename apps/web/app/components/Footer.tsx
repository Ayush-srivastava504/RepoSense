...
export default function Footer() {
    return (<footer className="border-t" style={{ borderColor: 'var(--line)' }}>
      <div className="container-xl py-10">
          ...
          <div className="flex flex-wrap gap-10">
            {columns.map((col) => (<div key={col.heading}>
                ...
                <ul className="space-y-2">
                  {col.links.map((l) => (<li key={l.href}>
                      <Link href={l.href} className="text-sm" style={{ color: 'var(--ink-soft)' }}>
                        {l.label}
                      </Link>
                    </li>))}
                </ul>
        ...
        <div className="mt-10 flex flex-col gap-3 border-t pt-6 sm:flex-row sm:items-center sm:justify-between" style={{ borderColor: 'var(--line)' }}>
