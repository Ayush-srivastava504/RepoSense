...
/**
 * Tiny inline "add your skills" form that powers the AI Job Match Score.
 * No account, no resume upload required — just a comma-separated list,
 * saved locally, used everywhere MatchScoreBadge renders.
 */
  ...
  return (
    <div className="panel flex flex-col gap-2 p-4">
      ...
      <textarea
        ...
        rows={2}
        placeholder="React, Python, SQL, AWS, Figma..."
