...
export default async function GovernmentJobDetailPage({ params, }: {
    ...
    return (<main className="w-full">
      ...
      <Script id="government-job-detail-native-banner" async data-cfasync="false" src="https://pl30201817.effectivecpmnetwork.com/0ecc31c4385791c7fa0bcc3db25e36c9/invoke.js" strategy="afterInteractive"/>
    </main>);
}
