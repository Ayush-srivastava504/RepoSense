        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Paste your resume text here (copy from your PDF/Word doc)…"
              rows={16}
          ...
          {result && (
            <div className="space-y-5">
              ...
              <div className="space-y-3">
                {result.checks.map((c) => (
                  <div key={c.id} className="rounded-[var(--radius-sm)] border p-3" style={{ borderColor: 'var(--line)' }}>
                    ...
                    {!c.passed && (
                      <p className="mt-1 text-xs" style={{ color: 'var(--ink)' }}>Tip: {c.tip}</p>
                    )}
                  </div>
                ))}
              </div>
