    ...
    >
      {currentPage > 1 && (
        <Link
          ...
          className="btn min-w-[40px] sm:min-w-[44px] px-2.5 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm touch-manipulation"
      ...
      {startPage > 1 && (
        <>
          ...
          {startPage > 2 && <span className="flex items-center px-1 sm:px-2 text-xs sm:text-sm">…</span>}
        </>
      )}
      ...
      {endPage < totalPages && (
        <>
          {endPage < totalPages - 1 && <span className="flex items-center px-1 sm:px-2 text-xs sm:text-sm">…</span>}
          <Link
