  ...
  return (
    <section id={id} className="py-10">
      ...
      <div className="mb-6">
        ...
        <h2 className="display mt-1 text-2xl font-medium">{title}</h2>
...
export default async function CompaniesPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-12">
      ...
      <header>
        <p className="eyebrow eyebrow-accent mb-2">// companies hiring</p>
        ...
        {totalCompanies > 0 && (
          <div className="mt-5 flex flex-wrap gap-2">
            {top.companies.length > 0 && (
              <a href="#top" className="chip chip-indigo text-xs">
                Top Companies ({top.total})
              </a>
            )}
            {mass_hire.companies.length > 0 && (
              <a href="#mass-hire" className="chip chip-green text-xs">
                Mass Hiring ({mass_hire.total})
              </a>
            )}
            {startup.companies.length > 0 && (
              <a href="#startups" className="chip chip-rust text-xs">
