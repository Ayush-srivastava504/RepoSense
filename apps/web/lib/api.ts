// Module: lib/api.ts
// Defines component(s)/export(s): API_URL
// Defines function(s): extractErrorMessage
//
...
export const api = {
    ...
    async pollJob(jobId: string, onProgress?: (status: string) => void, intervalMs = 3000, timeoutMs = 600000): Promise<any> {
